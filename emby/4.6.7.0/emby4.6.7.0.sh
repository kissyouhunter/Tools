...
if [ -e "/system/Emby.Web.dll" ]; then
    ...
    wget --no-check-certificate -O /system/Emby.Web.dll https://github.com/kissyouhunter/Tools/raw/main/emby/4.6.7.0/Emby.Web.dll
fi
sleep 1
if [ -e "/system/Emby.Web.dll" ]; then
...
if [ -e "/system/MediaBrowser.Model.dll" ]; then
    ...
    wget --no-check-certificate -O /system/MediaBrowser.Model.dll https://github.com/kissyouhunter/Tools/raw/main/emby/4.6.7.0/MediaBrowser.Model.dll
fi
sleep 1
if [ -e "/system/MediaBrowser.Model.dll" ]; then
...
if [ -e "/system/Emby.Server.Implementations.dll" ]; then
    ...
    wget --no-check-certificate -O /system/Emby.Server.Implementations.dll https://github.com/kissyouhunter/Tools/raw/main/emby/4.6.7.0/Emby.Server.Implementations.dll
fi
sleep 1
if [ -e "/system/Emby.Server.Implementations.dll" ]; then
...
if [ -e "/system/dashboard-ui/embypremiere/embypremiere.js" ]; then
    ...
    wget --no-check-certificate -O /system/dashboard-ui/embypremiere/embypremiere.js https://raw.githubusercontent.com/kissyouhunter/Tools/main/emby/4.6.7.0/embypremiere.js
fi
sleep 1
if [ -e "/system/dashboard-ui/embypremiere/embypremiere.js" ]; then
